...
public class ColorSplash extends Content {
        ...
        for (int z = 0; z < dimK; z++) {
          ...
          if (b > 0f) {
            addVoxelClamp(
              ...
              y,
              z,
              b * spheres[sphereIdx * 9 + 6],
              b * spheres[sphereIdx * 9 + 7],
              b * b * spheres[sphereIdx * 9 + 8]
            );
          }
        }
      }
  ...
  public ColorSplash(int dimI, int dimJ, int dimK) {
    super("ColorSplash", dimI, dimJ, dimK);
  ...
  private void initSphere(int sphereIdx, boolean firstTime) {
    ...
    ColorUtils.hsvToRgb(rnd.nextFloat(), 1f, 1f, spheres, sphereIdx * 9 + 6);
  }
